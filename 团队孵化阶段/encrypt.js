...
(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "a411c4d1664dd70048ee98afe7b28f0b",
        dm: ["oschina.net"],
    ...
    mt.cookie.set = function(a, b, g) {
        var d;
        g.Q && (d = new Date,
        d.setTime(d.getTime() + g.Q));
        document.cookie = a + "=" + b + (g.domain ? "; domain=" + g.domain : "") + (g.path ? "; path=" + g.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (g.Ec ? "; secure" : "")
    }
    ;
    ...
    ;
    mt.url.Ib = function(a) {
        return (a = a.match(/^(https?:\/\/)?([^\/\?#]*)/)) ? a[2].replace(/.*@/, "") : v
    }
    ;
    mt.url.L = function(a) {
        return (a = mt.url.Ib(a)) ? a.replace(/:\d+$/, "") : a
    }
    ;
    ...
    (function() {
                ...
                for (a = 0; e && a < d.length; ) {
                    ...
                    if (!("html" === m || "body" === m)) {
                        ...
                        if (p)
                            ...
                            for (var s = 0, t = 0, q = e.childNodes.length; t < q; t++) {
                                var y = e.childNodes[t];
                                1 === y.nodeType && y.nodeName.toLowerCase() === m && s++;
                                if (1 < s)
                                    return v
                            }
                            if (1 !== s)
                        ...
                        for (s = 0; s < e.childNodes.length; s++)
                            1 === e.childNodes[s].nodeType && e.childNodes[s].nodeName.toLowerCase() === m && f.push(e.childNodes[s]);
                        if (!f[b])
                            return v;
                        e = f[b]
                    }
        ...
        ;
        mt.f.ua = function(a, d) {
            var b = []
              , l = [];
            if (!a)
                return l;
            for (; a.parentNode != v; ) {
                for (var f = 0, m = 0, p = a.parentNode.childNodes.length, s = 0; s < p; s++) {
                    var t = a.parentNode.childNodes[s];
                    if (t.nodeName === a.nodeName && (f++,
                    t === a && (m = f),
                    0 < m && 1 < f))
                        break
                }
                if ((p = "" !== a.id) && d) {
                    ...
                    l.push(p)),
                    b.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < f ? "[" + m + "]" : ""));
                a = a.parentNode
            }
            l.push(b.join(">"));
            return l
        ...
        ;
        mt.f.va = function(a) {
            return (a = mt.f.ua(a, u)) && a.length ? String(a[0]) : ""
        }
        ;
        mt.f.Mb = function(a) {
            return mt.f.ua(a, w)
        ...
        mt.f.Cb = function(a) {
            var d;
            for (d = "A"; (a = a.parentNode) && 1 == a.nodeType; )
                if (a.tagName == d)
                    return a;
            return v
        }
        ...
        mt.f.Kb = function(a) {
            ...
            if (!a)
                return d;
            var b = mt.f.Eb(a).documentElement;
        ...
        mt.f.S = function(g, d) {
            var e;
            a.H(g) && 0 === String(g).indexOf("!HMCQ!") ? (e = String(g),
            e = b.m(document.location.href, e.substring(6, e.length))) : a.H(g) || (e = mt.f.T(g),
            ...
            e = e(g, "alt") || e(g, "title") || e(g, "src")) : e = "body" === e || "html" === e ? ["(hm-default-content-for-", e, ")"].join("") : mt.f.Pb(g));
    ...
    (function() {
        var a = mt.event;
        mt.g = {};
        mt.g.Aa = /msie (\d+\.\d+)/i.test(navigator.userAgent);
        mt.g.Jb = function() {
        ...
        mt.g.hc = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    ...
    mt.localStorage.set = function(a, b, g) {
        ...
        try {
            ...
            window.localStorage.setItem(a, b)) : mt.localStorage.la() && (mt.localStorage.l.expires = d.toUTCString(),
    ...
    h.D = {
        ...
        bb: "hm.baidu.com/hm.gif",
        rb: /^(tongji|hmcdn).baidu.com$/,
        jb: "tongji.baidu.com",
        Vb: "hmmd",
        Wb: "hmpl",
        tc: "utm_medium",
        ...
        wc: 1,
        Da: 2147483647,
        ib: "hca kb cc cf ci ck cl cm cp cu cw ds vl ep et fl ja ln lo lt rnd si su v cv lv api sn r ww p ct u tt".split(" "),
        V: u,
        Oa: ["a", "input", "button"],
        La: {
            id: "data-hm-id",
        ...
        Na: "data-hm-enabled",
        Ma: "data-hm-disabled",
        fc: "https://hmcdn.baidu.com/static/tongji/plugins/",
        ab: ["UrlChangeTracker"]
    };
    (function() {
        var a = {
            ...
            K: function(a, g) {
                this.F[a] = this.F[a] || [];
                for (var d = this.F[a].length, e = 0; e < d; e++)
                    this.F[a][e](g)
            }
        };
        return h.z = a
          ...
          , d = {
            ...
            ca: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var f = c.dm[a];
                    if (-1 < f.indexOf("/") && d.fa(document.location.href, f))
                        return f.replace(/^[^/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            }
        ...
        var a = mt.lang
          ...
          , m = {
            ...
            s: function(b) {
                ...
                m.Fa()) : "user" === b && a.d(d.user, "Object") ? (b = d.user.uid_,
                d.user = b === r ? {} : {
                    uid_: b
                },
                m.Fa()) : d[b] !== r && (d[b] = {}))
    ...
    (function() {
        ...
        if (b.isArray(c.cptrk) && 0 < c.cptrk.length) {
            var f = {
                    ...
                    for (var a, d = 0; d < c.cptrk.length; d++)
                        try {
                            ...
                            a.a !== r && b.d(a.a, "Object")) {
                                var e = a.a, l;
                                for (l in e)
                                    e.hasOwnProperty(l) && (f.ia[l] = String(e[l]))
                            }
                        } catch (q) {}
                },
                Za: function() {
                    var d, b, e;
                    for (e in f.ia)
                        if (f.ia.hasOwnProperty(e) && f.$a[e] === r && (d = f.ia[e],
                        d = a.sa(d)))
                            b = b === r ? {} : b,
                            b[e] = a.S(d, w),
                            f.$a[e] = u;
                ...
                Zb: function() {
                    "MutationObserver"in window ? (new MutationObserver(f.ya)).observe(document.body, {
                        childList: u,
                        subtree: u
          ...
          , g = {
            ba: function(a, e) {
                return function(l) {
                    ...
                    if (f) {
                        var m = f.getAttribute(a.ka);
                        l = l.clientX + ":" + l.clientY;
                        if (m && m === l)
                            f.removeAttribute(a.ka);
                        else if (e && 0 < e.length && (f = b.Mb(f)) && f.length)
                            if (m = f.length,
                            l = f[f.length - 1],
            ...
            gb: function(d, b) {
                ...
                d && (a.d(d, "Object") && d.Pa) && d.Pa(g)
            },
            gc: function(a, b) {
                return function(g) {
                    (g.target || g.srcElement).setAttribute(a.ka, g.clientX + ":" + g.clientY);
                    a && a.w && (b ? a.w(b) : a.w("#" + encodeURIComponent(this.id), g.type))
                }
            }
        };
        return h.ra = g
          ...
          , p = {
            ...
            mb: function() {
                if (c.cetrk && c.cetrk.length) {
                    g.e(document, "click", l.ba(p, c.cetrk));
            ...
            Db: function(b, d) {
                ...
                b.ec_ = a.getAttribute(f, g.aa) || a.getAttribute(f, "class") || "",
                b.ex_ = a.getAttribute(f, g.$) || a.va(f),
                b.en_ = a.getAttribute(f, g.content) || a.S(f, u),
                b.et_ = a.getAttribute(f, g.ha) || a.T(f),
                b.el_ = a.getAttribute(f, g.link) || a.getAttribute(f, "href") || "") : (b.ex_ = a.getAttribute(f, g.$) || a.va(f),
                b.en_ = a.getAttribute(f, g.content) || a.S(f, u)));
                return b
            },
            Nb: function(b, d) {
        ...
        var a = mt.lang
          ...
          , t = {
            ba: function() {
                return function(d) {
                    if (h.c && h.c.V && c.aet && c.aet.length) {
                        ...
                        if (f) {
                            var k = h.c.Oa
                              , n = b.getAttribute(f, e.Na) != v ? u : w;
                            if (b.getAttribute(f, e.Ma) == v)
                                if (n)
                                    t.ma(t.ta(f, d));
                                else {
                                    var x = b.T(f);
                                    if (a.G(k, "*") || a.G(k, x))
                                        ...
                                        for (; f.parentNode != v; ) {
                                            var n = f.parentNode
                                              , x = b.T(n)
                                              , z = "a" === x && a.G(k, "a") ? u : w
                                              , x = "button" === x && a.G(k, "button") ? u : w
                                              , A = b.getAttribute(n, e.Na) != v ? u : w;
                                            if (b.getAttribute(n, e.Ma) == v && (z || x || A)) {
                                                t.ma(t.ta(n, d));
                                                break
                                            }
                                            f = f.parentNode
            ...
            ta: function(f, g) {
                ...
                k.aa = b.getAttribute(f, n.aa) || b.getAttribute(f, "class") || "";
                k.$ = b.getAttribute(f, n.$) || b.va(f);
                k.content = b.getAttribute(f, n.content) || b.S(f, u);
                k.ha = b.getAttribute(f, n.ha) || b.T(f);
                k.link = b.getAttribute(f, n.link) || b.getAttribute(f, "href") || "";
                k.type = g.type || "click";
                n = a.Wa(f.offsetTop) ? f.offsetTop : 0;
                "click" === g.type ? n = d.Aa ? g.clientY + Math.max(document.documentElement.scrollTop, document.body.scrollTop) : g.pageY : "touchend" === g.type && (g.Ya && g.Ya.changedTouches) && (n = g.Ya.changedTouches[0].pageY);
                k.qc = n;
                n = this.Fb(g);
                k.Ca = n.Ca || 0;
                k.Ea = n.Ea || 0;
            ...
            Fb: function(f) {
                ...
                var x = n = 0
                  , z = 0
                  , A = 0;
                if (e && (n = e.offsetWidth || e.clientWidth,
                x = e.offsetHeight || e.clientHeight,
                A = b.Kb(e),
                z = A.left,
                A = A.top,
                a.d(e.getBBox, "Function") && (x = e.getBBox(),
                n = x.width,
                x = x.height),
                "html" === (e.tagName || "").toLowerCase()))
                    n = Math.max(n, e.clientWidth),
                    x = Math.max(x, e.clientHeight);
                return {
                    Ca: Math.round(100 * ((g - z) / n)),
                    Ea: Math.round(100 * ((f - A) / x)),
                    Ka: n,
                    xa: x,
                    Ia: ("a" === (e.tagName || "").toLowerCase() ? e : b.Cb(e)) ? "a" : "b"
                }
            },
            ma: function(b) {
                var d = a.h;
                b = [+new Date - (h.c.X !== r ? h.c.X : p), d(b.id), d(b.aa), d(b.ha), d(b.$), d(b.link), d(b.content), b.type, b.qc, b.Ca, b.Ea, b.Ka, b.xa, b.Ia].join("*");
                t.na(b);
                a.d(this.Z(), "Function") && this.Z()()
            },
            na: function(a) {
                a.length > e.oa || (encodeURIComponent(s.join("!") + a).length > e.oa && (t.w(s.join("!")),
                s = []),
                s.push(a))
            },
            w: function(a) {
            ...
            Z: function() {
                return function() {
                    s && s.length && (t.w(s.join("!")),
                    s = [])
                }
            }
        };
        a.H(c.aet) && "" !== c.aet && l.e("pv-b", function() {
            g.e(document, "click", t.ba());
            "ontouchend"in document && g.e(window, "touchend", t.ba());
            g.e(window, "unload", t.Z())
        });
        return t
    }
    )();
    (function() {
        var a = mt.lang
          ...
          , p = {
            pb: function() {
                a.H(c.aet) && "" !== c.aet && setInterval(p.fb, d.ic)
            },
            fb: function() {
                var a = g.U() + g.M();
          ...
          , s = {
            yb: function() {
                return function() {
                    h.c && (h.c.V && c.aet && c.aet.length) && (window.clearTimeout(m),
            ...
            ob: function(a) {
                s.na([+new Date - (h.c.X !== r ? h.c.X : l), a].join("*"))
            },
            na: function(a) {
                if (encodeURIComponent(f.join("!") + a).length > d.oa || 3 < f.length)
                    s.w(f.join("!")),
                    f = [];
                f.push(a)
            },
            ...
            Z: function() {
                return function() {
                    f && f.length && (s.w(f.join("!")),
                    f = [])
                }
            }
        };
        a.H(c.aet) && "" !== c.aet && e.e("pv-b", function() {
            b.e(window, "scroll", s.yb());
            b.e(window, "unload", s.Z());
            p.pb()
        });
        return s
    }
    ...
    (function() {
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                s = "focus" == a.type || "focusin" == a.type ? u : w,
                b()
        }
        var e = mt.event, l = h.z, f = u, m = u, p = u, s = u, t = +new Date, q = t, y = 0, k = u, n = g("visibilityState"), x = g("hidden"), z;
        b();
        (function() {
        ...
        var g = mt.url
          ...
          , k = {
            ...
            init: function() {
                ...
                m.e("stag-b", function() {
                    h.c.b.api = k.j || k.ga ? k.j + "_" + k.ga : "";
                    h.c.b.ct = [decodeURIComponent(t.getData("Hm_ct_" + c.id) || ""), k.C.Ja, k.C.page].join("!")
                });
                m.e("stag-d", function() {
                    h.c.b.api = 0;
                    k.j = 0;
            ...
            Ab: function() {
                if (0 < k.Y.length)
                    for (var a = 0, b = k.Y.length; a < b; a++)
                        k.Ga(k.Y[a]);
                k.Y = v
            },
            Ga: function(a) {
            ...
            _trackPageview: function(a) {
                if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                    ...
                    k.Xa || (h.c.b.su = document.location.href);
                    h.c.b.p = y(q.A("pageview"));
                    h.c.i();
                    h.c.b.u = b;
                    h.c.b.su = d;
                    h.c.b.p = "";
            ...
            _setUserTag: function(b) {
                if (!(3 > b.length)) {
                    ...
                    b = d.h(b[2]);
                    if (f !== r && b !== r) {
                        var e = decodeURIComponent(t.getData("Hm_ct_" + c.id) || "")
                          , e = a(e, f, 1, b);
                        t.setData("Hm_ct_" + c.id, encodeURIComponent(e), c.age)
                    }
                }
            },
            ...
            _clearAutoEventTrackingProperty: function(a) {
                1 < a.length && u === a[1] && q.s("autoEventTracking")
            },
            ...
            _providePlugin: function(a) {
                if (1 < a.length) {
                    var b = window._hmt
                      , e = a[1];
                    a = a[2];
                    if (d.G(f.ab, e) && d.d(a, "Function") && (b.plugins = b.plugins || {},
                    b.I = b.I || {},
                    b.plugins[e] = a,
                    b.B = b.B || [],
                    a = b.B.slice(),
                    e && a.length && a[0][1] === e))
                        for (var g = 0, k = a.length; g < k; g++) {
                            var l = a[g][2] || {};
                            if (b.plugins[e] && !b.I[e])
                                b.I[e] = new b.plugins[e](l),
                                b.B.shift();
                            else
                                break
                        }
    ...
    (function() {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = u,
            this.b = {},
            this.Va = this.Ua = u,
            this.V = k.V,
            this.Oa = e.H(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "",
            this.za = w,
            this.init())
        }
        var b = mt.url
        ...
        a.prototype = {
            ...
            Ob: function() {
                if (!document.referrer)
                    return k.J - k.N > c.vdur ? 1 : 4;
                var a = w;
                this.da(document.referrer) && this.da(document.location.href) ? a = u : (a = b.L(document.referrer),
                a = this.W(a || "", document.location.hostname));
            ...
            nc: function() {
                ...
                if (g = t.getData("Hm_lvt_" + c.id)) {
                    ...
                    e = "",
                    f = 1;
                this.ac() ? (t.setData("Hm_lvt_" + c.id, g, c.age),
                t.setData("Hm_lpvt_" + c.id, k.J),
                d = l.ec(this.R(), this.ca())) : this.Bb();
                if (0 === c.nv && this.da(document.location.href) && ("" === document.referrer || this.da(document.referrer)))
                    a = 0,
                    b = 4;
                this.b.nv = a;
                this.b.st = b;
            ...
            ac: function() {
                ...
                return !e.G("sjh.baidu.com isite.baidu.com ls.wejianzhan.com bs.wejianzhan.com product.weijianzhan.com qianhu.weijianzhan.com aisite.wejianzhan.com".split(" "), a)
            },
            Bb: function() {
            ...
            mc: function() {
                for (var a = [], b = this.b.et, d = 0, e = k.ib.length; d < e; d++) {
                    var f = k.ib[d]
                      , g = this.b[f];
            ...
            oc: function() {
                ...
                this.b.cm = b.m(a, k.Vb) || "";
                this.b.cp = b.m(a, k.Wb) || b.m(a, k.tc) || "";
                this.b.cw = b.m(a, k.Ub) || b.m(a, k.vc) || "";
                this.b.ci = b.m(a, k.Sb) || b.m(a, k.sc) || "";
                this.b.cf = b.m(a, k.Xb) || b.m(a, k.uc) || "";
                this.b.cu = b.m(a, k.Tb) || b.m(a, k.rc) || "";
                f.bc() && (this.b.u = window.location.href)
            },
            init: function() {
                try {
                    this.oc(),
                    0 === this.b.nv ? this.lc() : this.Qa(),
                    h.c = this,
                    this.vb(),
                    this.ub(),
                    x.K("pv-b"),
            ...
            vb: function() {
                var a = document.location.hash.substring(1)
                  , d = RegExp(c.id)
                  , e = b.L(document.referrer) === k.jb ? 1 : 0
                  , f = b.m(a, "jn")
                  , g = /^select$/.test(f);
                a && (d.test(a) && e && g) && (this.b.rnd = Math.round(Math.random() * k.Da),
            ...
            eb: function(a) {
                ...
                if (b.length) {
                    ...
                    b.length ? m.set("Hm_unsent_" + c.id, p.stringify(b)) : this.Qa()
                }
            },
            Qa: function() {
    ...
    (function() {
        var a = mt.g
          ...
          , g = mt.event
          , d = mt.o;
        if ("undefined" !== typeof h.c && (c.med || (!a.Aa || 7 < a.Jb()) && c.cvcc)) {
                ...
                var k = function(a, d) {
                    ...
                    if (b.d(d, "Array") || b.d(d, "NodeList"))
                        for (var e = 0, f = d.length; e < f; e++)
                            if (y === d[e])
                                return t(l + a + "/" + (e + 1), d[e]),
                                w
                };
                g.e(document, "mousedown", function(a) {
                    a = a || window.event;
                    y = a.target || a.srcElement;
                    var d = {};
                    for (s(m, function(a, e) {
                        d[a] = b.d(e, "Function") ? e() : document.getElementById(e)
                    }); y && y !== document && s(d, k) !== w; )
                        y = y.parentNode
                })
            }
        }
            ...
            var e = {
                nb: function() {
                    for (var b = c.cvcf.length, d, m = 0; m < b; m++)
                        (d = a.Ra(decodeURIComponent(c.cvcf[m]))) && g.e(d, "click", e.ra())
                },
                ra: function() {
                    return function() {
                        h.c.b.et = 86;
